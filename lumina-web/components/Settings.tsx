  ...
  return (
    <div className="space-y-8 relative">
                        ...
                        <table className="min-w-full divide-y divide-gray-100 dark:divide-gray-800">
                            <thead className="bg-gray-50 dark:bg-gray-900">
                                <tr>
                                    ...
                                    <th className="px-5 py-3 text-left text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider hidden sm:table-cell">{t('settings.circuitBreaker.table.stats')}</th>
                            ...
                            <tbody className="bg-white dark:bg-[#1a1a1a] divide-y divide-gray-100 dark:divide-gray-800">
                                {isCBListLoading && circuitBreakers.length === 0 ? (
                                    ...
                                    <tr><td colSpan={5} className="p-6 text-center text-sm text-gray-500">No active providers found</td></tr>
                                ) : (
                                    circuitBreakers.map((cb) => (
                                        <tr key={cb.providerId} className="hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                                            ...
                                            <td className="px-5 py-3.5 whitespace-nowrap text-sm text-gray-500 dark:text-gray-400 font-mono">
                                                {cb.score.toFixed(1)}
                                            </td>
                                            <td className="px-5 py-3.5 whitespace-nowrap text-xs text-gray-500 dark:text-gray-400 hidden sm:table-cell">
                                                <span className="text-red-500 font-medium">{Math.round(cb.errorRate * 100)}% Err</span> <span className="text-gray-300 dark:text-gray-600 mx-1">/</span> <span className="text-amber-500 font-medium">{Math.round(cb.slowRate * 100)}% Slow</span>
                                            </td>
      ...
      {isCBModalOpen && selectedCB && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-sm p-4 animate-fade-in">
            <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-float max-w-md w-full animate-in zoom-in-95 duration-200 border border-gray-100 dark:border-gray-800">
                <div className="px-6 py-4 border-b border-gray-100 dark:border-gray-800 flex justify-between items-center bg-white/95 dark:bg-[#1a1a1a]/95 backdrop-blur rounded-t-2xl">
                    ...
                    <button onClick={() => setIsCBModalOpen(false)} className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 rounded-full p-1 hover:bg-gray-100 dark:hover:bg-gray-800">
                        <X size={20} />
                    </button>
                </div>
                <div className="p-6">
                    <div className="mb-6">
                        ...
                        <p className="text-lg font-bold text-gray-900 dark:text-white mt-1">{selectedCB.providerName}</p>
                    ...
                    <form onSubmit={handleControlSubmit} className="space-y-5">
                        <div>
                            ...
                            <select 
                                ...
                                className="block w-full rounded-xl border-gray-200 dark:border-gray-700 shadow-sm focus:border-black dark:focus:border-white focus:ring-black dark:focus:ring-white text-sm py-2.5 px-3 bg-white dark:bg-gray-950 dark:text-white cursor-pointer"
                            >
                        ...
                        {cbTargetState === 'OPEN' && (
                            <div className="animate-in slide-in-from-top-2">
                                ...
                                <input 
                                    ...
                                    className="block w-full rounded-xl border-gray-200 dark:border-gray-700 shadow-sm focus:border-black dark:focus:border-white focus:ring-black dark:focus:ring-white text-sm py-2.5 px-3 bg-white dark:bg-gray-950 dark:text-white"
                                />
                            </div>
                        )}
                        ...
                        <div>
                            ...
                            <textarea 
                                ...
                                className="block w-full rounded-xl border-gray-200 dark:border-gray-700 shadow-sm focus:border-black dark:focus:border-white focus:ring-black dark:focus:ring-white text-sm py-2.5 px-3 bg-white dark:bg-gray-950 dark:text-white resize-none"
                            />
                        </div>
                        ...
                        <div className="pt-4 flex justify-end gap-3">
                            ...
                            <button 
                                type="submit"
                                disabled={isCBSaving}
                                className="px-4 py-2.5 bg-gray-900 hover:bg-black dark:bg-white dark:hover:bg-gray-200 text-white dark:text-black text-sm font-semibold rounded-xl shadow-sm flex items-center disabled:opacity-70 disabled:cursor-not-allowed transition-all hover:-translate-y-0.5"
                            >
